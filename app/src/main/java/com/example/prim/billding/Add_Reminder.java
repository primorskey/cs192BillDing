...
/*
	...
	{4.0} <Paul Matthew Sason |date|
	[the Views in the xml were named "editText1", "editText2", etc, which are renamed to prper names so they were also
	changed here]
*/
...
public class Add_Reminder extends AppCompatActivity {
    ...
    public void fileWriter(String[] array, String name, String amt, String desc, String date){
     ...
     // handles what happens when the user clicks the back icon on top, call the onBackPressed function
     @Override
     ...
     //create an alert dialog whenever the user chooses to exit the activity
    @Override
    public void onBackPressed(){
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case DialogInterface.BUTTON_POSITIVE:
                        Toast.makeText(getBaseContext(), "Adding Cancelled", Toast.LENGTH_SHORT).show(); //feedback for cancelling the add
        ...
        confirmCancel.setMessage("Are you sure you want to cancel adding?").setPositiveButton("Yes",dialogClickListenerDelete).setNegativeButton("No",dialogClickListenerDelete).show();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateField.setHint("(e.g. " + formatted + ")");


        Bundle b = this.getIntent().getExtras(); //creates a bundle to store the data given by MainActivity
        final String[] array = b.getStringArray("key"); //creates a String array to contain the data found in b
        ...
        /*
         ...
         current number of reminders is written first followed by all of the current reminders and finally the newly added reminder. Once the reminders are
         successfully saved, the user is return to the main menu.
        */
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(billName) || TextUtils.isEmpty(billDate) || TextUtils.isEmpty(billAmount)) {
                    ...
                    fileWriter(array,newBillName,formattedTemp,newBillDescription,billDate);
                    Toast.makeText(getBaseContext(), "Reminder Saved", Toast.LENGTH_SHORT).show(); //feedback for successfully adding to the database file
        ...
        final DatePickerDialog.OnDateSetListener date = new DatePickerDialog.OnDateSetListener() {
            ...
            private void updateLabel() {
                ...
                if(myCalendar.getTimeInMillis() < c2.getTimeInMillis()){
                    ...
                    DatePickerDialog temp = new DatePickerDialog(Add_Reminder.this, this, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH)); //creates a date picker dialog
        ...
        /*
        Function that enables the user to pick a date from the ddate picker by clicking on the date field
         */
        dateField.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                DatePickerDialog temp = new DatePickerDialog(Add_Reminder.this, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH)); //creates a date picker dialog
                Calendar c = Calendar.getInstance();
                c.set(Calendar.HOUR_OF_DAY,0);
                c.set(Calendar.MINUTE,0);
                c.set(Calendar.SECOND,0);
